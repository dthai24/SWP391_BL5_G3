    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="header-configure-area">
            <div class="language-option">
                <img src="<%= request.getContextPath() %>/img/flag.jpg" alt="">
        ...
        <nav class="mainmenu mobile-menu">
            <ul>
                ...
                <li><a href="<%= request.getContextPath() %>/pages.jsp">Pages</a>
                    <ul class="dropdown">
                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    ...
                                    <li><a href="<%= request.getContextPath() %>/rooms.jsp">Rooms</a></li>
                                    <li class="active"><a href="<%= request.getContextPath() %>/about-us.jsp">About Us</a></li>
                                    <li><a href="<%= request.getContextPath() %>/pages.jsp">Pages</a>
                                        <ul class="dropdown">
                                            <li><a href="<%= request.getContextPath() %>/room-details.jsp">Room Details</a></li>
                                            <li><a href="<%= request.getContextPath() %>/blog-details.jsp">Blog Details</a></li>
