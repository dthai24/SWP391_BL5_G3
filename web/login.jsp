    ...
    <body>
       ...
       if (error != null) { %>
                        ...
                        <button type="button" class="btn btn-danger btn-block mb-2" id="googleLoginBtn">
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/SWP391_BL5_G3/LoginGoogle&response_type=code&client_id=471950650741-6r7sm4m1ek988ucbejr5okfqi28d1tl2.apps.googleusercontent.com&prompt=consent">
